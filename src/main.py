...
tracks_help      = 'Tracks you want to download exercises from.\n' \
                   'To list all available tracks run: exercism-bd --list-tracks.\n' \
...
list_tracks_help = 'Lists all currently available tracks.\n '


parser = argparse.ArgumentParser(description=description, formatter_class=argparse.RawTextHelpFormatter)

parser.add_argument('--list-tracks', required=False, action='store_true', help=list_tracks_help)
